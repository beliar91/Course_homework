class AdvertismentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advertisment.save
        format.html { redirect_to @advertisment.user, notice: 'Advertisment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @advertisment.update(advertisment_params)
        format.html { redirect_to @advertisment.user, notice: 'Advertisment was successfully updated.' }
  ...
  private
    ...
    def advertisment_params
      params.require(:advertisment).permit(:description, :title, :photo, :user_id)
    end
end
